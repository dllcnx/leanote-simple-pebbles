  ...
  return function (e) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), function (e) {
      ...
      function v(e, t) {
        ...
        if (!g(e)) return e;
        var o = e.attributes || e.props, i = G.h(e.nodeName || e.type, o, e.children || o && o.children), a = [i, t];
    ...
    var l = n(195), f = 36e5, p = 6e4, d = 2, h = /[T ]/, m = /:/, v = /^(\d{2})$/,
      ...
      S = /^(\d{2}):?(\d{2}([.,]\d*)?)$/, O = /^(\d{2}):?(\d{2}):?(\d{2}([.,]\d*)?)$/, A = /([Z+-].*)$/, k = /^(Z)$/,
      T = /^([+-])(\d{2})$/, M = /^([+-])(\d{2}):?(\d{2})$/;
    e.exports = r
  }, function (e, t) {
    e.exports = function (e, t) {
    ...
    e.exports = function (e, t, n, m, v, g, y) {
      ...
      var b, _, w, x = function (e) {
        ...
        }, E = t + " Iterator", N = "values" == v, C = !1, S = e.prototype, O = S[p] || S["@@iterator"] || v && S[v],
        A = O || x(v), k = v ? N ? x("entries") : A : void 0, T = "Array" == t ? S.entries || O : O;
      if (T && (w = f(T.call(new e))) !== Object.prototype && (l(w, E, !0), r || u(w, p) || a(w, p, h)), N && O && "values" !== O.name && (C = !0, A = function () {
        return O.call(this)
      }), r && !y || !d && !C && S[p] || a(S, p, A), s[t] = A, s[E] = h, v) if (b = {
        values: N ? A : x("values"),
        keys: g ? A : x("keys"),
        entries: k
      ...
      e.exports = function (e) {
        return new Promise(function (l, f) {
          ...
          if (h.open(e.method.toUpperCase(), i(e.url, e.params, e.paramsSerializer), !0), h.timeout = e.timeout, h[m] = function () {
            ...
            var b = n(173), _ = (e.withCredentials || u(e.url)) && e.xsrfCookieName ? b.read(e.xsrfCookieName) : void 0;
    ...
    var f = n(88), p = r(f), d = function () {
      ...
      return (0, u.default)(e, [{
        key: "render", value: function (e) {
          ...
          if (e instanceof HTMLElement) t = e; else if (!(t = document.getElementById(e))) return ;
    ...
    (function (t) {
      ...
      e.exports = function (e, n) {
        ...
        var C = "function" == typeof Symbol && Symbol.iterator, S = "@@iterator", O = "<<anonymous>>", A = {
          array: p("array"),
          bool: p("boolean"),
          func: p("function"),
          number: p("number"),
    ...
    !function () {
      ...
      function E(e, t, n) {
        var r, o = B[e.name];
        if (e.prototype && e.prototype.render ? (r = new e(t, n), k.call(r, t, n)) : (r = new k(t, n), r.constructor = e, r.render = N), o) for (var i = o.length; i--;) if (o[i].constructor === e) {
      ...
      function S(e, t, n, o) {
        if (!e.__x) {
          var i, a, u, s = e.props, l = e.state, f = e.context, p = e.__p || s, d = e.__s || l, h = e.__c || f,
            g = e.base, y = e.__b, _ = g || y, w = e._component, x = !1;
      ...
      var M = {}, P = [], j = [], D = /acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i, I = [], L = [], R = 0,
        F = !1, G = !1, B = {};
      r(k.prototype, {
 ...
 */
      !function (t, n) {
        ...
        var z = H, U = 0, X = void 0, W = void 0, Y = function (e, t) {
        ...
        var ee = Math.random().toString(36).substring(16), te = void 0, ne = 1, re = 2, oe = new S, ie = new S, ae = 0;
    ...
    var o = n(89), i = r(o), a = n(107), u = r(a), s = n(111), c = r(s), l = n(48), f = r(l), p = n(49), d = r(p),
      ...
      N = n(143), C = r(N);
    n(151);
    var S = n(67), O = n(73), A = r(O), k = n(181), T = r(k), M = n(182), P = r(M), j = n(183), D = r(j), I = n(74),
      L = r(I), R = n(211), F = n(212), G = r(F), B = function (e) {
        function t(e) {
          ...
          n.state = {
            ...
            n.setState({isPreview: !n.state.isPreview}), S.axiosGithub.post("/markdown", {text: n.state.comment}, {headers: n.accessToken && {Authorization: "token " + n.accessToken}}).then(function (e) {
            ...
            enableHotKey: !0,
            url: location.href,
            defaultAuthor: {avatarUrl: "//avatars1.githubusercontent.com/u/29697133?s=50", login: "null", url: ""},
          ...
          if (o.code) {
            ...
            history.replaceState(null, null, a), n.options = (0, u.default)({}, n.options, {
              ...
              e.data && e.data.access_token ? (n.accessToken = e.data.access_token, n.getInit().then(function () {
                ...
                console.log("err:", e), n.setState({isIniting: !1, isOccurError: !0, errorMsg: (0, S.formatErrorMsg)(e)})
        ...
        return (0, g.default)(t, e), (0, d.default)(t, [{
          ...
          key: "getIssueById", value: function () {
            var e = this, t = this.options, n = t.owner, r = t.repo, o = t.number, a = t.clientID, u = t.clientSecret,
          ...
          key: "createIssue", value: function () {
            var e = this, t = this.options, n = t.owner, r = t.repo, o = t.title, i = t.body, a = t.id, u = t.labels,
              s = t.url;
          ...
          key: "noInit", value: function () {
            var e = this.state, t = e.user, n = e.isIssueCreating, r = this.options, o = r.owner, i = r.repo, a = r.admin;
          ...
          key: "header", value: function () {
            var e = this, t = this.state, n = t.user, r = t.comment, o = t.isCreating, i = t.previewHtml, a = t.isPreview;
            return b.default.createElement("div", {
              className: "gt-header",
              key: "header"
          ...
          key: "meta", value: function () {
            var e = this.state, t = e.user, n = e.issue, r = e.isPopupVisible, o = e.pagerDirection, i = e.localComments,
              a = (n && n.comments) + i.length, u = "last" === o, s = this.options.updateCountCallback;
          ...
          key: "render", value: function () {
            var e = this.state, t = e.isIniting, n = e.isNoInit, r = e.isOccurError, o = e.errorMsg, i = e.isInputFocused;
          ...
          key: "loginLink", get: function () {
            var e = this.options.clientID, t = {client_id: e, redirect_uri: location.href, scope: "public_repo"};
    ...
    E || (_ = function (e) {
      ...
      all: function (e) {
        var t = this, n = S(t), r = n.resolve, o = n.reject, i = A(function () {
          var n = [], i = 0, a = 1;
          h(e, !1, function (e) {
            var u = i++, s = !1;
        ...
        var t = this, n = S(t), r = n.reject, o = A(function () {
          h(e, !1, function (e) {
    ...
    "use strict";
    var r = n(2), o = n(11), i = n(9), a = n(6), u = n(54), s = n(120).KEY, c = n(15), l = n(39), f = n(25), p = n(24),
      d = n(1), h = n(44), m = n(45), v = n(121), g = n(122), y = n(123), b = n(8), _ = n(12), w = n(30), x = n(19),
      E = n(36), N = n(124), C = n(66), S = n(7), O = n(17), A = C.f, k = S.f, T = N.f, M = r.Symbol, P = r.JSON,
      j = P && P.stringify, D = d("_hidden"), I = d("toPrimitive"), L = {}.propertyIsEnumerable,
      R = l("symbol-registry"), F = l("symbols"), G = l("op-symbols"), B = Object.prototype, H = "function" == typeof M,
      z = r.QObject, U = !z || !z.prototype || !z.prototype.findChild, X = i && c(function () {
        return 7 != E(k({}, "a", {
          get: function () {
        ...
        return e === B && V(G, t, n), b(e), t = w(t, !0), b(n), o(F, t) ? (n.enumerable ? (o(e, D) && e[D][t] && (e[D][t] = !1), n = E(n, {enumerable: x(0, !1)})) : (o(e, D) || k(e, D, x(1, {})), e[D][t] = !0), X(e, t, n)) : k(e, t, n)
      }, q = function (e, t) {
        b(e);
    ...
    var d = n(138), h = r(d), m = n(141), v = n(46), g = (0, m.whichTransitionEvent)(), y = !g, b = function (e) {
      function t() {
        ...
        return n = r = i(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(p))), r.state = {
          ...
          if (!n) return !1;
          var a = r.props, c = a.appearAnimation, l = a.enterAnimation, f = a.leaveAnimation, p = a.getPosition,
            d = e.appearing && c, h = e.entering && l, v = e.leaving && f;
          if (d || h || v) return !0;
          ...
          return a(n, t), l(n, [{
            ...
            key: "convertTimingProp", value: function (e) {
              ...
              if (isNaN(r)) {
                ...
                return "production" !== v && (0, d.invalidTypeForTimingProp)({prop: e, value: t, defaultValue: o}), o
              }
              return r
            }
          }, {
...
*/
    !function (n, a) {
      ...
      function n(e) {
        ...
        function r() {
          var t = e.style.height, r = n(e), o = document.documentElement && document.documentElement.scrollTop;
          e.style.height = "auto";
    ...
    var o = n(144), i = r(o), a = n(145), u = r(a), s = n(146), c = r(s), l = n(147), f = r(l), p = n(148), d = r(p),
      h = n(149), m = r(h), v = n(150), g = r(v), y = {
        zh: u.default,
        "zh-CN": u.default,
        "zh-TW": c.default,
        en: f.default,
 ...
 */
    ...
    n(210);
    var x = (0, d.default)(), E = (0, m.default)(), N = (0, g.default)(), C = (0, b.default)(), S = (0, w.default)();
    ...
    function r(e) {
      var t = this, n = this.options, r = n.owner, o = n.repo, s = n.perPage, c = n.pagerDirection, l = n.defaultAuthor,
